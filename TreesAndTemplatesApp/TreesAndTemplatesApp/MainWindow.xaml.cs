...
namespace TreesAndTemplatesApp
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private Control _controlToExamine = null;
        ...
        private void btnShowVisuaTree_Click(object sender, RoutedEventArgs e)
        {
            _dataToShow = "";
        ...
        private void ShowTemplate()
        {
            ...
            if(_controlToExamine != null)
            {
                stackTemplatePanel.Children.Remove(_controlToExamine);
            }
            try
            {
                //Load PresentationFramework, and create an instance of the specified control
                //Give it a size for display purposes, then add to the empty StackPanel
                Assembly asm = Assembly.Load("PresentationFramework, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35");
                _controlToExamine = (Control)asm.CreateInstance(txtFullName.Text);
                _controlToExamine.Height = 200;
                _controlToExamine.Width = 200;
                _controlToExamine.Margin = new Thickness(5);
                stackTemplatePanel.Children.Add(_controlToExamine);
                ...
                //Create and XmlWriter based on our settings
                ...
                XamlWriter.Save(_controlToExamine.Template, xWriter);
