namespace AutoLotDAL2.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<AutoLotDAL2.EF.AutoLotEntities>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "AutoLotDAL2.EF.AutoLotEntities";
        }

        protected override void Seed(AutoLotDAL2.EF.AutoLotEntities context)
        {
            ...
            customers.ForEach(x => context.Customers.AddOrUpdate(x));
            ...
            cars.ForEach(x => context.Inventory.AddOrUpdate(x));
            ...
            orders.ForEach(x => context.Orders.AddOrUpdate(x));
